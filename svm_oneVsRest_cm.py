...
X, y = load_h5py('/home/nehaj/Desktop/Assignment2_ML/data/data_2.h5')
...
plt.savefig('ConfusionMatricesAndROC/data3_confusionmatrix_linearKernel')
plt.show()
