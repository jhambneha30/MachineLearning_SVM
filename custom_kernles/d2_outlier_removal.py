...
# Label 0: BLUE:
# ('========min dist from mean is:===========', 0.3524784614455676)
# ('========max dist from mean is:===========', 1.2486894243113844)

# Label 1: BROWN:
# ('========min dist from mean is:===========', 0.36113691964952843)
# ('========max dist from mean is:===========', 1.1970974646871737)
...
X_arr, y_arr = load_h5py('/home/nehaj/Desktop/Assignment2_ML/data/data_2.h5')
...
plt.xticks(())
plt.yticks(())
plt.savefig('plots/data2_kernel_noOutlier')
plt.show()
